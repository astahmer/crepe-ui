import { cva, cx } from "@crepe-ui/styled-system/css";
import { styled } from "@crepe-ui/styled-system/jsx";
import {
  HTMLStyledProps,
  RecipeVariantProps,
} from "@crepe-ui/styled-system/types";
...
export interface InputAddonProps
  extends HTMLStyledProps<"div">,
    NonNullable<RecipeVariantProps<typeof styles>> {}
  ...
  function InputAddon(props, ref) {
    ...
    return (
      <styled.div
        ...
        {...rest}
        className={cx(styles({ placement }), className)}
        ref={ref}
      />
    );
  }
