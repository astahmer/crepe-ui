...
import "../static.css";
import { ToTokenRecord, assignInlineVars } from "@crepe-ui/shared";
...
export const Sandbox = () => {
  ...
  return (
    <Stack p="4">
      ...
      {/* <CardExample /> */}
      <ColorModeDemo />
      <h1 className={css({ textStyle: "heading.uppercase" })}>
        Sandbox: Panda components
      </h1>
      <Wrap>
        {/* <div
          style={
            getColorSchemeVars({ medium: 'red' }, 'crepe-ui') as Record<
              string,
              string
            >
          }
...
const ColorModeDemo = () => {
  const color = useColorModeValue(
    token("colors.blue.300"),
    token("colors.amber.300")
  );
    ...
    <>
      <Modal open={isOpen} onExitComplete={onClose}>
        ...
        <Portal>
          ...
          <Modal.Container>
            <Modal.Content>
              <Modal.Header>crepe-ui Modal Title</Modal.Header>
              ...
              <Modal.Body>
                <span>
                  ...
                  nostrud elit officia tempor esse quis. Sunt ad dolore quis
                  aute consequat. Magna exercitation reprehenderit magna aute
