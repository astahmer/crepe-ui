...
import { alert } from '@pacha/styled-system/recipes'
import type { SystemStyleObject } from '@pacha/styled-system/types'
...
function CheckIcon({ css: cssProp, ...props }: IconProps) {
	return (
		<AlertIcon>
			<svg {...props} className={css({ h: '100%', w: '100%' }, cssProp)} viewBox="0 0 24 24">
				<path
					fill="currentColor"
...
function InfoIcon({ css: cssProp, ...props }: IconProps) {
	return (
		<AlertIcon>
			<svg {...props} className={css({ h: '100%', w: '100%' }, cssProp)} viewBox="0 0 24 24">
				<path
...
function WarningIcon({ css: cssProp, ...props }: IconProps) {
	return (
		<AlertIcon>
			<svg {...props} className={css({ h: '100%', w: '100%' }, cssProp)} viewBox="0 0 24 24">
				<path
