...
import { SelectVariantProps, select } from '@pacha/styled-system/recipes'
...
interface JsxProps<T extends Ark.CollectionItem> extends PreferRight<Ark.SelectProps<T>, StyleProps> {}

export interface SelectProps<T extends Ark.CollectionItem> extends JsxProps<T>, SelectVariantProps {}
...
interface SelectItemProps
	extends Assign<
			HTMLArkProps<'div'>,
			{
				children?: React.ReactNode | ((props: zag.ItemState) => React.ReactNode)
			}
		>,
		zag.ItemProps {}

interface SelectItemGroupProps extends Assign<HTMLArkProps<'div'>, zag.ItemGroupProps> {}
...
const SelectItem = withContext(
	styled(Ark.Select.Item as ForwardRefExoticComponent<ComponentProps<'div'> & SelectItemProps>),
	'item',
)
